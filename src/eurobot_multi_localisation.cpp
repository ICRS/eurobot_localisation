...
int main(int argc, char** argv){
    ...
    if(!nh.getParam("localisation_node/colour", eurobot::constants::colour)){
    ...
    tf2::Quaternion q;
    q.setRPY(ex, ey, ez);
    eurobot::constants::T_BC = tf2::Transform(q, r);
    eurobot::constants::T_CB = eurobot::constants::T_BC.inverse();
